...
export const reservoirAbi = [
  ...
  {
    inputs: [
      { name: "_swapAddress", type: "address" },
      { name: "_collateralAddress", type: "address" },
    ],
    payable: false,
    stateMutability: "nonpayable",
    type: "constructor",
  ...
  { payable: true, stateMutability: "payable", type: "fallback" },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "invested", type: "uint256" },
      { indexed: false, name: "tokens", type: "uint256" },
      { indexed: false, name: "soldTokens", type: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "customerAddress", type: "address" },
      { indexed: false, name: "incomingeth", type: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: "ethEarned", type: "uint256" },
      { indexed: false, name: "timestamp", type: "uint256" },
    ],
    name: "onTokenSell",
    type: "event",
  },
  {
    ...
    inputs: [
      { indexed: true, name: "customerAddress", type: "address" },
      { indexed: false, name: "ethReinvested", type: "uint256" },
      { indexed: false, name: "tokensMinted", type: "uint256" },
      { indexed: false, name: "timestamp", type: "uint256" },
    ],
    name: "onReinvestment",
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, name: "customerAddress", type: "address" },
      { indexed: false, name: "ethWithdrawn", type: "uint256" },
      { indexed: false, name: "timestamp", type: "uint256" },
    ],
    name: "onWithdraw",
    type: "event",
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: "bnbBalance", type: "uint256" },
      { indexed: false, name: "tokenBalance", type: "uint256" },
      { indexed: false, name: "timestamp", type: "uint256" },
    ],
    name: "onBalance",
    type: "event",
